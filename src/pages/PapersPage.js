        ...
        return (
            <li key={index} className="md:text-lg flex flex-col items-center text-center space-y-1.5">
                ...
                <a href={paper.link} target="_blank" rel="noopener noreferrer"
                   className="w-fit hover:underline underline-offset-1 text-tangerine">https://www.published.com</a>
                <a href={paper.pdfFile} target="_blank" rel="noopener noreferrer"
                   className="flex items-center justify-center gap-x-0.5 hover:underline underline-offset-1 text-tangerine"> <ImFilePdf/>Download</a>
            </li>
        )
    })
